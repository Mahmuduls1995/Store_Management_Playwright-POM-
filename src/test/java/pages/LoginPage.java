            ...
            if (email.isVisible()) {
                ...
                if (password.isVisible()) {
                    ...
                    if (loginButton.isVisible()) {
                        ...
                        handleFail("Login Button is not locatable, please check the error message", "login_fail");
                    }
                } else {
                    handleFail("Password is not locatable, please check the error message", "password_fail");
                }
            } else {
                handleFail("Email is not locatable, please check the error message", "'email_fail");
            }
        } catch (Exception e) {
